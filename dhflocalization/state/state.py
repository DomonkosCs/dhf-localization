...
class StateHypothesis:
    ...
    @classmethod
    def init_from_particle_prior(cls, particle_num, particle_mean, particle_covar):
        particles = np.random.multivariate_normal(
            particle_mean, particle_covar, particle_num)
        return cls.init_from_particle_poses(particles)

    @classmethod
    def init_from_particle_poses(cls, particles):
